...
public class AnimatedSprite extends Sprite {
    ...
    public AnimatedSprite(Image image, Component component, int width, int height) {
        ...
        buffer = new BufferedImage(model, Raster.createWritableRaster(model.createCompatibleSampleModel(newWidth, newHeight), new DataBufferInt(pixels, pixelCount), null), false, new Hashtable<Object, Object>());
        scaleDetail = 0;
        autoUpdate = true;
        update();
    }
