...
public class RSInterface {
	...
	public static RSInterface addContainer(int id, int width, int height, int xPad, int yPad, boolean move, String... actions) {
		...
		container.invGlow = new int[width * height];
		container.bonus = new int[width * height];
		container.actions = actions;
		container.dragDeletes = move;
		return container;
	}
	...
	public static void addToItemGroup(int id, int w, int h, int x, int y, boolean hasActions, boolean displayAmount, String[] actions, boolean displayExamine) {
		...
		widget.invGlow = new int[w * h];
		widget.bonus = new int[w * h];
	...
	public static void itemGroup(int id, int w, int h, int x, int y, int... itemId) {
		...
		rsi.invGlow = new int[w * h];
		rsi.bonus = new int[w * h];
...
//these were diff btw not both supposed to be 1405 i guess
	...
	public static void goodiebagInterface(TextDrawingArea[] tda) { // open urcache,.
		...
		addText(STARTING_POINT + 2, "Tarn's Goodiebag", tda, 2, ColorConstants.ORANGE, false, true);
	...
	public static void customCollectionLog(TextDrawingArea[] tda) {
		...
		items.width = 224;
		items.scrollMax = 280;
		itemGroup(STARTING_POINT + 15, 6, 10, 6, 6);
	//	addToItemGroup(STARTING_POINT + 15, 6, 10, 6, 6, true, new String[]{null, null, null, null, null});
		...
		addRectangle(30710, 240, 1, 0x5A4F3A, 200, true);
		addToItemGroup(30711, 4, 2, 6, 1, false, new String[]{null, null, null, null, null});

		addHoverableText(30712, "Claim Reward", "Claim", tda, 2, false, false, 100, ColorConstants.ORANGE, 0xb9a888);

		main.child(14, 30710, 212, 240);
		main.child(15, 30711, 212, 241);
		main.child(16, 30712, 360, 262);
	...
	private static void effectInterfaceNew(TextDrawingArea[] tda) {
		RSInterface main = addInterface(58350);
		addSpriteLoader(58351, 3310);
		addText(58352, "000 Minutes", tda, 0, ColorConstants.ORA, false, true);
		addText(58353, "Aggro", tda, 0, ColorConstants.SNOW_WHITE, false, true);
		main.totalChildren(3);
		main.child(0, 58351, 35 + 100 - 8 + 330 + 15, 275 + 8 + 5 - 215);
		main.child(1, 58352, 11 + 102 + 330 + 15, 305 + 5 + 5 - 215);
		main.child(2, 58353, 11 + 106 + 330 + 15, 305 - 5 + 5 - 215);
	}

	private static void effectInterfaceNew2(TextDrawingArea[] tda) {
		RSInterface main = addInterface(58360);
		addSpriteLoader(58361, 3308);
		addText(58362, "000 Minutes", tda, 0, ColorConstants.ORA, false, true);
		addText(58363, "Exp Bonus", tda, 0, ColorConstants.SNOW_WHITE, false, true);
		main.totalChildren(3);
		//main.child(0, 58361, 35 + 100 - 8 + 330 + 15, 275 + 8 + 5 - 260);
		//main.child(1, 58362, 11 + 102 + 330 + 15, 305 + 5 + 5 - 260);
		//main.child(2, 58363, 11 + 106 + 330 + 15, 305 - 5 + 5 - 260);
		main.child(0, 58361, 35 + 200 - 8 + 165, 275 + 8 + 5);
		main.child(1, 58362, 11 + 202 + 165, 305 + 5 + 5);
		main.child(2, 58363, 11 + 206 + 165, 305 - 5 + 5);
	}

	private static void effectInterfaceNew3(TextDrawingArea[] tda) {
		RSInterface main = addInterface(58370);
		addSpriteLoader(58371, 3306);
		addText(58372, "000 Minutes", tda, 0, ColorConstants.ORA, false, true);
		addText(58373, "DR Bonus", tda, 0, ColorConstants.SNOW_WHITE, false, true);
		main.totalChildren(3);
		main.child(0, 58371, 35 + 100 - 8 + 330 + 15, 275 + 8 + 5 - 170);
		main.child(1, 58372, 11 + 102 + 330 + 15, 305 + 5 + 5 - 170);
		main.child(2, 58373, 11 + 106 + 330 + 15, 305 - 5 + 5 - 170);
	}

	private static void effectInterfaceNew4(TextDrawingArea[] tda) {
		RSInterface main = addInterface(58380);
		addSpriteLoader(58381, 3309);
		addText(58382, "000 Minutes", tda, 0, ColorConstants.ORA, false, true);
		addText(58383, "DDR Bonus", tda, 0, ColorConstants.SNOW_WHITE, false, true);
		main.totalChildren(3);
		main.child(0, 58381, 35 + 100 - 8 + 330 + 15, 275 + 8 + 5 - 125);
		main.child(1, 58382, 11 + 102 + 330 + 15, 305 + 5 + 5 - 125);
		main.child(2, 58383, 11 + 106 + 330 + 15, 305 - 5 + 5 - 125);
	}

	private static void effectInterfaceNew5(TextDrawingArea[] tda) {
		RSInterface main = addInterface(58390);
		addSpriteLoader(58391, 3307);
		addText(58392, "000 Minutes", tda, 0, ColorConstants.ORA, false, true);
		addText(58393, "DMG Bonus", tda, 0, ColorConstants.SNOW_WHITE, false, true);
		main.totalChildren(3);
		main.child(0, 58391, 35 + 100 - 8 + 330 + 15, 275 + 8 + 5 - 80);
		main.child(1, 58392, 11 + 102 + 330 + 15, 305 + 5 + 5 - 80);
		main.child(2, 58393, 11 + 106 + 330 + 15, 305 - 5 + 5 - 80);
	}
	...
	public static void newStarter(TextDrawingArea[] tda) {
		...
		addText(52752, "Tarn game mode selection screen", ColorConstants.ORANGE, true, true, 52, tda, 2);
		...
		addText(52764, "Play Tarn as an Iron man.", ColorConstants.ORANGE2, true, true, 52, tda, 0);
	...
	public static void donationDeals(TextDrawingArea[] tda) {
		...
		addText(57268, "You can only claim items if you donate required amount within 24 hours.", ColorConstants.YELLOW, false, true, 52, tda, 0);
		addText(57269, "NOTE:", 0xd17c15, false, true, 52, tda, 1);
		addText(57270, "This only counts with Store donations, bonds aren't applicable.", ColorConstants.YELLOW, false, true, 52, tda, 0);
		...
		addHoverText(57282, "   Visit Donation Page", "Donate", tda, 1, ColorConstants.LIME_GREEN, false, true, 100, 14);
		main.totalChildren(17);
	...
	public static void BoxRewardList(TextDrawingArea[] textDrawingAreas) {
		...
		RSInterface.addText(17552, "Tarn Rewards List", textDrawingAreas, 2, 0xEAC117, true);
	...
	public static void addHolyWithTooltip(int i, int configId, int configFrame,
		...
		Interface.opacity = 0;
		Interface.hoverType = Hover;
		Interface.disabledSprite = Client.spritesMap.get(3311);//background sprite for prayer
		Interface.width = 34;
		Interface.height = 34;
		Interface.valueCompareType = new int[1];
		Interface.requiredValues = new int[1];
	...
	public static void addBobStorage(int index) {
		...
		rsi.invGlow = new int[30];
		rsi.bonus = new int[30];
		rsi.inv = new int[30];
		rsi.spritesY = new int[20];
	...
	public static void addAdvancedButtonWSpriteLoader(int id, int sprite, String tooltip, int w, int h) {
		RSInterface tab = interfaceCache[id] = new RSInterface();
		tab.id = id;
		tab.parentID = id;
		tab.type = 5;
	...
	static void unpack(Archive streamLoader, TextDrawingArea textDrawingAreas[], Archive streamLoader_1, RSFontSystem[] newFontSystem) {
		...
		interfaceCache = new RSInterface[165000];
		while (stream.position < stream.buffer.length) {
			...
			if (rsInterface.type == 2) {
				...
				rsInterface.invGlow = new int[rsInterface.width * rsInterface.height];
				rsInterface.bonus = new int[rsInterface.width * rsInterface.height];
				...
				for (int j2 = 0; j2 < 20; j2++) {
					...
					if (k3 == 1) {
						...
						rsInterface.spritesX[11] = -95;
						rsInterface.spritesY[11] = -158;
						rsInterface.sprites[11] = method207(12, streamLoader_1,
								"wornicons");
						assert rsInterface.sprites[11] != null;
						rsInterface.sprites[11].drawOffsetX = -9;
						rsInterface.sprites[11].drawOffsetY = -3;

						rsInterface.spritesX[14] = -16;
						rsInterface.spritesY[14] = -196;
						rsInterface.sprites[14] = method207(13, streamLoader_1,
								"wornicons");
						assert rsInterface.sprites[14] != null;
						rsInterface.sprites[14].drawOffsetX = -7;
						rsInterface.sprites[14].drawOffsetY = -7;

						rsInterface.spritesX[8] = 0;
						rsInterface.spritesY[8] = 2;
						rsInterface.sprites[8] = method207(14, streamLoader_1,
								"wornicons");
						assert rsInterface.sprites[8] != null;
						rsInterface.sprites[8].drawOffsetX = -7;
						rsInterface.sprites[8].drawOffsetY = -7;

						rsInterface.spritesX[6] = -1;
						rsInterface.spritesY[6] = -1;
						rsInterface.sprites[6] = method207(15, streamLoader_1,
								"wornicons");
						assert rsInterface.sprites[6] != null;
						rsInterface.sprites[6].drawOffsetX = -5;
						rsInterface.sprites[6].drawOffsetY = -4;
		...
		try {
			CustomInterfaces.upgrade(textDrawingAreas);
			...
			effectInterfaceNew(textDrawingAreas);
			effectInterfaceNew2(textDrawingAreas);
			effectInterfaceNew3(textDrawingAreas);
			effectInterfaceNew4(textDrawingAreas);
			effectInterfaceNew5(textDrawingAreas);
...
//        addHoveredImageWSpriteLoader(id + 400, 1050, 124, 34, id + 401);
		...
		addText(id, "Welcome to Tarn", fonts, 2, 0xFF981F, true, true);
	...
	public static RSInterface copy(int id, int id1) {
		...
		tab.invGlow = copy.invGlow;
		tab.bonus = copy.bonus;
