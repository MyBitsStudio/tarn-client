...
public enum ModIcon {
	...
	MODERATOR(828, 1), ADMINISTRATOR(829, 2), OWNER(830, 3), DEVELOPER(831, 4), CONTRIBUTOR(831, 6), REGULAR_DONATOR(832, 7), SUPER_DONATOR(833, 9), EXTREME_DONATOR(834, 11), SPONSOR_DONATOR(835, 12), ZENYTE_DONATOR(1508, 13), YOUTUBER(837, 8);
