...
//                itemDefs = ItemDefinition.get(19146);
//                itemDef.modelOffsetX = itemDefs.modelOffsetX;
//                itemDef.modelOffsetY = itemDefs.modelOffsetY;
//                itemDef.modelZoom = itemDefs.modelZoom;
//                itemDef.rotationY = itemDefs.rotationY;
...
//                break;
//            case 21011:
//                itemDef.name = TierColor.BEGGINER.getColor()+"Owl Body";
//                 itemDefs = ItemDefinition.get(5575);
//                itemDef.modelOffsetX =  itemDefs.modelOffsetX;
...
//                break;
//            case 21012:
//                itemDef.name = TierColor.BEGGINER.getColor()+"Owl Legs";
//                 itemDefs = ItemDefinition.get(5576);
//                itemDef.modelOffsetX =  itemDefs.modelOffsetX;
//                itemDef.modelOffsetY = 10;
...
//                break;
//            case 21014:
//                itemDef.name = TierColor.BEGGINER.getColor()+"Owl Staff";
...
//
//            case 17640:
//    itemDef.name = TierColor.NOVICE.getColor() + "Angelic body";
...
//
//            case 17642:
//    itemDef.name = TierColor.NOVICE.getColor() + "Angelic legs";
...
//                break;
//            case 2021:
//    itemDef.name = TierColor.NOVICE.getColor() + "Angelic wings";
...
//     case 18007:
//    itemDef.name = TierColor.NOVICE.getColor() + "Revenant Shield";
//    itemDef.modelID = 65506;
//    itemDef.maleEquip1 = 65507;
//    itemDef.femaleEquip1 = 65507;
//    itemDefs = ItemDefinition.get(18509);
