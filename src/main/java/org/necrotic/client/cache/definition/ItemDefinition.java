	...
	public static void applyTexturing(Model model, int id) {
		...
		switch (id) {
			...
			case 23217:
				...
				break;
			case 23218:
				model.setTexture(66, 70);
				break;
			case 23219:
				model.setTexture(66, 71);
				break;
...
//				break;
			...
			case 18647:
				//itemDef.actions = new String[]{"@cya@Teleport To Chest", null, null, null, null};
				itemDef.name = "@cya@Elite Slayer Key";
				itemDef.modelID = 139871;
...
//				break;
			...
			case 20493:
				...
				break;
			case 20494:
				itemDef.name = "<shad=1>@bla@Toxic Twisted Bow";
				...
				break;
			case 20495:
				itemDef.name = "<shad=1>@bla@Toxic Sanguinesti Staff";
				itemDef.actions = new String[5];
				itemDef.actions[1] = "Wear"/*done*/; //done
itemDef.actions[2] = "Dissolve";
				itemDef.actions[4] = "Drop";
				...
				break;
			case 20496:
				itemDef.name = "<shad=1>@bla@Toxic Scythe Of Vitur";
...
//				break;
			...
			case 22038:
				...
				itemDef.name = "Exode Robe Bottoms";
...
//armour sets start
			...
			case 11938:
				...
				break;
			case 14525:
				itemDef.name = "Solar Set";
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Open";
				break;
			case 11946:
				itemDef.name = "Executive Set";
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Open";
				break;
			case 11942:
				itemDef.name = "Nite Set";
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Open";
				break;
			case 11944:
				itemDef.name = "Lili Set";
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Open";
				break;
			case 19592:
				itemDef.name = "Varth Set";
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Open";
				break;
			case 11926:
				itemDef.name = "Tyrant Set";
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Open";
				break;
			case 14529:
				itemDef.name = "Lucifer Set";
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Open";
				break;
			case 19582:
				itemDef.name = "Virtuos Set";
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Open";
				break;
			case 9666:
				itemDef.name = "Agumon Set";
				itemDef.actions = new String[5];
				itemDef.actions[0] = "Open";
				break;
			case 11874:
...
itemDef.actions[2] = "Dissolve";
			...
			case 16196:
				...
				break;
			case 1857:
				itemDef.name = "Blood Enhancement";
				itemDef.actions = new String[]{null, "Wear", "Dissolve", null, "Drop"};
				break;
...
//				break;
			...
			case 12612:// super sayian
				itemDef.name = "@red@Obsidian Aura";
...
/*
	...
	public RarityColor rarityColortype;
