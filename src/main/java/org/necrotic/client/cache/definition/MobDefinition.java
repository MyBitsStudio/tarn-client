...
public final class MobDefinition {
	...
	public static MobDefinition get(int id) {
		...
		switch (id) {
			...
			// <img=1419> diamond
			case 13738:
				definition.npcModels = new int[]{139_811};
				MobDefinition b17122522 = get(202);
				definition.name = "Smithing Master";
				definition.combatLevel = 0;
				definition.scaleXZ = 150;
				definition.scaleY = 150;
				definition.npcSizeInSquares = 1;
				definition.actions = new String[]{"Talk-to", null, null, null, null};
				definition.description = b17122522.description;
				definition.drawYellowDotOnMap = true;
				//definition.npcModels = b17122.npcModels.clone();
				definition.standAnimation = b17122522.standAnimation;
				definition.walkAnimation = b17122522.walkAnimation;
				definition.degreesToTurn = 0;
				//definition.rdc2 = 7454;
				break;

			case 14378:
				definition.name = "@whi@Cherubimon";
				MobDefinition resk = get(3308);
				definition.npcModels = new int[]{141250};
				definition.combatLevel = 2490;
				definition.scaleXZ = 100;
				definition.scaleY = 100;
				definition.npcSizeInSquares = 1;
				definition.description = "Fear the god of all that is".getBytes();
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = resk.standAnimation;
				definition.walkAnimation = resk.walkAnimation;
			...
			case 9906:
				...
				break;
			case 7553:
				definition.name = "@whi@General Khazard";
				definition.description = "It's a General Khazard.".getBytes();
				definition.combatLevel = 1495;
...
//				MobDefinition rek = get(3308);
//				definition.npcModels = new int[]{141250};
//
//				definition.combatLevel = 600;
//				definition.scaleXZ = 200;
//				definition.scaleY = 200;
//				definition.npcSizeInSquares = 1;
//				definition.description = "TESTING".getBytes();
//				definition.drawYellowDotOnMap = true;
...
//				break;
			...
			case 4969:
				...
				break;
//			case 3:
//				definition.name = "<col=ff00fb>Pon's Present";
...
//
			...
			case 9029:
				definition.setDefault();
				definition.name = "Nightmare of the Reckless";
			...
			case 9030:
				definition.setDefault();
				definition.name = "Patience of the Forsaken";
			...
			case 9807:
				definition.setDefault();
				definition.name = "Imperial Paladin";
				...
				definition.drawYellowDotOnMap = true;
				definition.npcSizeInSquares = 1;
				definition.scaleXZ = 228;
				definition.scaleY = 228;
				break;
			...
			case 9837:
				definition.setDefault();
				definition.name = "Blurite Goblin";
				definition.npcModels = new int[]{100283};
				definition.combatLevel = 36;
				definition.standAnimation = MobDefinition.get(1).standAnimation;
				definition.walkAnimation = MobDefinition.get(1).walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.drawYellowDotOnMap = true;
				definition.npcSizeInSquares = 3;
				definition.scaleXZ = 12;
				definition.scaleY = 12;
				break;
			case 9838:
				definition.setDefault();
				definition.name = "Imperial hound";
			...
			case 9845:
				definition.setDefault();
				definition.name = "Imperial Scorpion";
...
//				break;
			...
			case 436:
				...
				break;
			case 9903:
				definition.name = "@red@Asmodeus";
				definition.npcModels = new int[]{100407};
				MobDefinition lightguild = get(202);
				definition.combatLevel = 906;
				...
				break;
			case 9910:
				definition.name = "@cya@Imperial Ranger";
				definition.npcModels = new int[]{100406};
				MobDefinition lightguild2223 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild2223.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild2223.standAnimation;
				definition.walkAnimation = lightguild2223.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
			case 9911:
				definition.name = "@cya@Blurite Werewolf";
				definition.npcModels = new int[]{139770};
				MobDefinition lightguild3232 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild3232.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild3232.standAnimation;
				definition.walkAnimation = lightguild3232.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
			case 9912:
				definition.name = "@red@Calamity";
				definition.npcModels = new int[]{139777};
				MobDefinition lightguild32323 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild32323.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild32323.standAnimation;
				definition.walkAnimation = lightguild32323.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
			case 9913:
				definition.name = "@bla@Slender Man";
				definition.npcModels = new int[]{139780};
				MobDefinition lightguild3232343 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild3232343.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild3232343.standAnimation;
				definition.walkAnimation = lightguild3232343.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
			case 9914:
				definition.name = "@blu@Sasuke";
				definition.npcModels = new int[]{139794};
				MobDefinition lightguild32323432 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild32323432.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild32323432.standAnimation;
				definition.walkAnimation = lightguild32323432.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
			case 9915:
				definition.name = "@bla@Death God";
				definition.npcModels = new int[]{139797};
				MobDefinition lightguild323234323 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild323234323.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild323234323.standAnimation;
			...
			case 9916:
				...
				definition.npcModels = new int[]{139798};
				MobDefinition lightguild3232343234 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild3232343234.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild3232343234.standAnimation;
				definition.walkAnimation = lightguild3232343234.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
			case 9917:
				definition.name = "@bla@Vol'goth";
				definition.npcModels = new int[]{139810};
				MobDefinition lightguild32323432344 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild32323432344.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild32323432344.standAnimation;
				definition.walkAnimation = lightguild32323432344.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
				case 9918:
				definition.name = "@yel@Broly";
				definition.npcModels = new int[]{97020};
				MobDefinition lightguild323234323445 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild323234323445.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild323234323445.standAnimation;
				definition.walkAnimation = lightguild323234323445.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
				case 9919:
				definition.name = "@yel@Bowser";
				definition.npcModels = new int[]{99000};
				MobDefinition lightguild3232343234452 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild3232343234452.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild3232343234452.standAnimation;
				definition.walkAnimation = lightguild3232343234452.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
				case 9920:
				definition.name = "@bla@Ig'thaur";
				definition.npcModels = new int[]{99828};
				MobDefinition lightguild32323432344523 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild32323432344523.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild32323432344523.standAnimation;
				definition.walkAnimation = lightguild32323432344523.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
				case 9921:
				definition.name = "@red@Zernath";
				definition.npcModels = new int[]{99839};
				MobDefinition lightguild323234323445235 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild323234323445235.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild323234323445235.standAnimation;
				definition.walkAnimation = lightguild323234323445235.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
				case 9922:
				definition.name = "@red@Blurite Centaur";
				definition.npcModels = new int[]{99891};
				MobDefinition lightguild3232343234452352 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild3232343234452352.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild3232343234452352.standAnimation;
				definition.walkAnimation = lightguild3232343234452352.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
				case 9923:
				definition.name = "@red@Armoured Tiger";
				definition.npcModels = new int[]{100026};
				MobDefinition lightguild32323432344523523 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild32323432344523523.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild32323432344523523.standAnimation;
				definition.walkAnimation = lightguild32323432344523523.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
				...
				// NEW BOSSES
			case 3010:
				definition.name = "@whi@Zeidan Grimm";
				definition.npcModels = new int[]{139754};
				MobDefinition lightguild323234323445235233 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild323234323445235233.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild323234323445235233.standAnimation;
				definition.walkAnimation = lightguild323234323445235233.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;

			case 3011:
				definition.name = "@red@Janemba";
				definition.npcModels = new int[]{139761};
				MobDefinition lightguild3232343234452352335 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 35;
				definition.scaleY = 35;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild3232343234452352335.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild3232343234452352335.standAnimation;
				definition.walkAnimation = lightguild3232343234452352335.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;

			case 3012:
				definition.name = "@whi@Shadow Golem";
				definition.npcModels = new int[]{139793};
				MobDefinition lightguild323234323445235233523 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild323234323445235233523.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild323234323445235233523.standAnimation;
				definition.walkAnimation = lightguild323234323445235233523.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;

			case 3013:
				definition.name = "@bla@Ag'thomoth";
				definition.npcModels = new int[]{139799};
				MobDefinition demon12 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 100;
				definition.scaleY = 100;
				//definition.npcSizeInSquares = 1;
				definition.description = demon12.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = demon12.standAnimation;
				definition.walkAnimation = demon12.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;

			case 3014:
				definition.name = "@whi@Lilinryss";
				definition.npcModels = new int[]{139804};
				MobDefinition demon123 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = demon123.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = demon123.standAnimation;
				definition.walkAnimation = demon123.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;

			case 3015:
				definition.name = "@whi@Damascus";
				definition.npcModels = new int[]{139805};
				MobDefinition demon1234 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = demon1234.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = demon1234.standAnimation;
				definition.walkAnimation = demon1234.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;

			case 3016:
				definition.name = "@whi@Varthramoth";
				definition.npcModels = new int[]{139806};
				MobDefinition demon12345 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = demon12345.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = demon12345.standAnimation;
				definition.walkAnimation = demon12345.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;

//			case 3017:
//				definition.name = "@whi@Exodia";
//				definition.npcModels = new int[]{139807};
//				MobDefinition demon123456 = get(202);
//				definition.combatLevel = 906;
//				definition.scaleXZ = 155;
//				definition.scaleY = 155;
//				//definition.npcSizeInSquares = 1;
//				definition.description = demon123456.description;
//				definition.drawYellowDotOnMap = true;
//				definition.standAnimation = demon123456.standAnimation;
//				definition.walkAnimation = demon123456.walkAnimation;
//				definition.actions = new String[]{null, "Attack", null, null, null};
//				definition.npcSizeInSquares = 1;
//				break;
//
//			case 3018:
//				definition.name = "@whi@Magician Girl";
//				definition.npcModels = new int[]{139808};
//				MobDefinition demon1234567 = get(202);
//				definition.combatLevel = 906;
//				definition.scaleXZ = 155;
//				definition.scaleY = 155;
//				//definition.npcSizeInSquares = 1;
//				definition.description = demon1234567.description;
//				definition.drawYellowDotOnMap = true;
//				definition.standAnimation = demon1234567.standAnimation;
//				definition.walkAnimation = demon1234567.walkAnimation;
//				definition.actions = new String[]{null, "Attack", null, null, null};
//				definition.npcSizeInSquares = 1;
//				break;

			case 3019:
				definition.name = "@red@Virtuoso";
				definition.npcModels = new int[]{139809};
				MobDefinition demon12345678 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = demon12345678.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = demon12345678.standAnimation;
			...
			case 3020:
				definition.name = "@cya@Agumon";
				definition.npcModels = new int[]{139850};
				MobDefinition demon123456789 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = demon123456789.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = demon123456789.standAnimation;
				definition.walkAnimation = demon123456789.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;

			case 3021:
				definition.name = "@whi@White Beard";
				definition.npcModels = new int[]{97300};
				MobDefinition demon1234567891 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 155;
				definition.scaleY = 155;
				//definition.npcSizeInSquares = 1;
				definition.description = demon1234567891.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = demon1234567891.standAnimation;
				definition.walkAnimation = demon1234567891.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;

			case 3022:
				definition.name = "@yel@Luffy Pet";
				definition.npcModels = new int[]{139798};
				MobDefinition lightguild3232343234123 = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 50;
				definition.scaleY = 50;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild3232343234123.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild3232343234123.standAnimation;
				definition.walkAnimation = lightguild3232343234123.walkAnimation;
				definition.actions = new String[]{null, "Pick-up", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
			...
			case 3023:
				definition.name = "@red@Sanctum Golem pet";
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.combatLevel = 0;
				definition.npcSizeInSquares = 1;
				definition.standAnimation = 808;
				definition.walkAnimation = 819;
				definition.scaleXZ = 33;
				definition.scaleY = 33;
				definition.npcModels = new int[1];
			...
			case 3024:
				definition.setDefault();
				definition.name = "@red@Mutant Hydra pet";
				definition.npcModels = new int[]{100305};
				definition.combatLevel = 0;
				definition.standAnimation = MobDefinition.get(138).standAnimation;
				definition.walkAnimation = MobDefinition.get(138).walkAnimation;
			...
			case 9808:
				definition.setDefault();
				definition.name = "@cya@Gorvek pet";
			...
			case 3025:
				definition.setDefault();
				definition.name = "@red@Dragonite pet";
				definition.npcModels = new int[]{100238};
				definition.combatLevel = 0;
				definition.standAnimation = 5022;
				definition.walkAnimation = 5022;
				...
				definition.drawYellowDotOnMap = false;
				definition.npcSizeInSquares = 1;
				definition.scaleXZ = 16;
				definition.scaleY = 16;
				break;
			case 9905:
				definition.name = "@red@Asmodeus Pet";
				definition.npcModels = new int[]{100407};
				MobDefinition lightguild3 = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 45;
				definition.scaleY = 45;
				//definition.npcSizeInSquares = 1;
				definition.description = lightguild3.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = lightguild3.standAnimation;
				definition.walkAnimation = lightguild3.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3026:
				definition.name = "Malvek pet";
				...
				break;
			case 3027:
				MobDefinition GrifPet = get(8549);
				definition.name = "Onyx Griffin pet";
				definition.combatLevel = 0;
				definition.scaleXZ = 45;
				definition.scaleY = 45;
				definition.npcSizeInSquares = 1;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.description = GrifPet.description;
				definition.drawYellowDotOnMap = false;
				definition.npcModels = GrifPet.npcModels.clone();
				definition.standAnimation = GrifPet.standAnimation;
				definition.walkAnimation = GrifPet.walkAnimation;
				definition.degreesToTurn = 32;
				definition.rdc2 = 36323;
				break;
			case 3028:
				definition.name = "@whi@Zeidan Grimm pet";
				definition.npcModels = new int[]{139754};
				MobDefinition GrimPet = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 45;
				definition.scaleY = 45;
				//definition.npcSizeInSquares = 1;
				definition.description = GrimPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = GrimPet.standAnimation;
				definition.walkAnimation = GrimPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3029:
				definition.name = "@bla@Ag'thomoth pet";
				definition.npcModels = new int[]{139799};
				MobDefinition MothPet = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 22;
				definition.scaleY = 22;
				//definition.npcSizeInSquares = 1;
				definition.description = MothPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = MothPet.standAnimation;
				definition.walkAnimation = MothPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3030:
				definition.name = "@whi@Lilinryss pet";
				definition.npcModels = new int[]{139804};
				MobDefinition RyssPet = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 45;
				definition.scaleY = 45;
				//definition.npcSizeInSquares = 1;
				definition.description = RyssPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = RyssPet.standAnimation;
				definition.walkAnimation = RyssPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3031:
				definition.name = "Groudon pet";
				...
				break;
			case 3032:
				definition.name = "@whi@Varthramoth pet";
				definition.npcModels = new int[]{139806};
				MobDefinition VarmothPet = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 22;
				definition.scaleY = 22;
				//definition.npcSizeInSquares = 1;
				definition.description = VarmothPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = VarmothPet.standAnimation;
				definition.walkAnimation = VarmothPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3033:
				definition.npcModels = new int[]{65332};
				definition.name = "Tyrant Lord pet";
				definition.combatLevel = 0;
				definition.standAnimation = 5022;
				definition.walkAnimation = 5022;
				//definition.rdc2 = 2592952;
			...
			case 9013:
				...
				break;
			case 3034:
				definition.name = "@red@Virtuoso pet";
				definition.npcModels = new int[]{139809};
				MobDefinition OsoPet = get(202);
				definition.combatLevel = 906;
				definition.scaleXZ = 75;
				definition.scaleY = 75;
				//definition.npcSizeInSquares = 1;
				definition.description = OsoPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = OsoPet.standAnimation;
				definition.walkAnimation = OsoPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3035:
				definition.name = "@cya@Agumon pet";
				definition.npcModels = new int[]{139850};
				MobDefinition MonPet = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 75;
				definition.scaleY = 75;
				//definition.npcSizeInSquares = 1;
				definition.description = MonPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = MonPet.standAnimation;
				definition.walkAnimation = MonPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3036:
				definition.name = "@whi@White Beard pet";
				definition.npcModels = new int[]{97300};
				MobDefinition BeardPet = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 75;
				definition.scaleY = 75;
				//definition.npcSizeInSquares = 1;
				definition.description = BeardPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = BeardPet.standAnimation;
				definition.walkAnimation = BeardPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3037:
				definition.name = "Panther pet";
				MobDefinition PantPet = MobDefinition.get(2292);
				definition.description = "GWD.".getBytes();
				definition.combatLevel = 0;
				definition.npcModels = new int[]{65177};
				definition.combatLevel = PantPet.combatLevel;
				definition.standAnimation = PantPet.standAnimation;
				definition.walkAnimation = PantPet.walkAnimation;
				definition.scaleXZ = 75;
				definition.scaleY = 75;
				definition.actions = new String[5];
				definition.actions[0] = null;
			...
			case 3038:
				...
				break;
			case 3039:
				definition.name = "@red@Calamity pet";
				definition.npcModels = new int[]{139777};
				MobDefinition MityPet = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 55;
				definition.scaleY = 55;
				//definition.npcSizeInSquares = 1;
				definition.description = MityPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = MityPet.standAnimation;
				definition.walkAnimation = MityPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3040:
				definition.name = "@bla@Slender Man pet";
				definition.npcModels = new int[]{139780};
				MobDefinition ManPet = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 65;
				definition.scaleY = 65;
				//definition.npcSizeInSquares = 1;
				definition.description = ManPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = ManPet.standAnimation;
				definition.walkAnimation = ManPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3041:
				definition.name = "Charybdis pet";
				definition.combatLevel = 0;
			...
			case 3043:
				...
				break;
			case 3044:
				definition.name = "Ezkel-Nojad pet";
				definition.actions = new String[5];
				definition.actions[0] = null;
				...
				break;
			case 3045:
				definition.name = "@red@Janemba pet";
				definition.npcModels = new int[]{139761};
				MobDefinition EmbaPet = get(202);
				definition.combatLevel = 0;
				definition.scaleXZ = 16;
				definition.scaleY = 16;
				//definition.npcSizeInSquares = 1;
				definition.description = EmbaPet.description;
				definition.drawYellowDotOnMap = false;
				definition.standAnimation = EmbaPet.standAnimation;
				definition.walkAnimation = EmbaPet.walkAnimation;
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.npcSizeInSquares = 1;
				break;
			case 3046:
				definition.name = "Frieza pet";
				...
				break;
			case 928:
				definition.name = "Perfect Cell pet";
			...
			case 3047:
				...
				//definition.npcModels[1] = -1; //JAW
				definition.npcModels[1] = 64126; //BODY
				definition.npcModels[2] = 65449; //CAPE
				definition.npcModels[3] = 64130; //GLOVES
				//definition.npcModels[5] = -1; ////shield
				//definition.npcModels[6] = -1; //WEP
				definition.npcModels[4] = 64128; //LEG
				definition.npcModels[5] = 64131; //BOOT
				break;
			case 3048:
				definition.name = "Byakuya pet";
				definition.actions = new String[5];
				definition.actions[0] = null;
				definition.combatLevel = 0;
				definition.npcSizeInSquares = 1;
				...
				definition.npcModels[2] = 64130; //GLOVES
			...
			case 9904:
				definition.npcModels = new int[]{100405};
				MobDefinition b17122 = get(202);
				definition.name = "Nine Tails";
				definition.combatLevel = 1974;
				definition.scaleXZ = 200;
				definition.scaleY = 200;
				definition.npcSizeInSquares = 1;
			...
			case 9907:
				...
				definition.name = "Meruem The King";
				definition.combatLevel = 90000;
				definition.scaleXZ = 300;
				definition.scaleY = 300;
				definition.npcSizeInSquares = 1;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.description = b171224.description;
				definition.drawYellowDotOnMap = true;
				//definition.npcModels = b17122.npcModels.clone();
				definition.standAnimation = b171224.standAnimation;
				definition.walkAnimation = b171224.walkAnimation;
				definition.degreesToTurn = 32;
				//definition.rdc2 = 7454;
				break;
			case 9908:
				definition.npcModels = new int[]{139_760};
				MobDefinition b171225 = get(202);
				definition.name = "Golden Great Ape";
				definition.combatLevel = 900000;
				definition.scaleXZ = 200;
				definition.scaleY = 200;
				definition.npcSizeInSquares = 1;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.description = b171225.description;
				definition.drawYellowDotOnMap = true;
				//definition.npcModels = b17122.npcModels.clone();
				definition.standAnimation = b171225.standAnimation;
				definition.walkAnimation = b171225.walkAnimation;
				definition.degreesToTurn = 32;
				//definition.rdc2 = 7454;
				break;
//			case 9909:
//				definition.npcModels = new int[]{139_881};
//				MobDefinition b1712252 = get(202);
//				definition.name = "<img=1419><col=C3C0B2>Forger";
//				definition.combatLevel = 0;
//				definition.scaleXZ = 75;
//				definition.scaleY = 75;
//				definition.npcSizeInSquares = 1;
//				definition.actions = new String[]{null, "Talk-to", null, null, null};
//				definition.description = b1712252.description;
//				definition.drawYellowDotOnMap = true;
//				//definition.npcModels = b17122.npcModels.clone();
//				definition.standAnimation = b1712252.standAnimation;
//				definition.walkAnimation = b1712252.walkAnimation;
//				definition.degreesToTurn = 32;
//				//definition.rdc2 = 7454;
//				break;
			case 438: // Corrupt
				...
				definition.scaleY = 250;
				definition.npcSizeInSquares = 1;
				definition.description = lightguild2.description;
				definition.drawYellowDotOnMap = true;
				definition.standAnimation = lightguild2.standAnimation;
				definition.walkAnimation = lightguild2.walkAnimation;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.npcSizeInSquares = 1;
				break;
			case 440:
			...
			case 605:
				...
				//definition.npcModels[1] = 246; //JAW
				definition.npcModels[1] = 64309; //CHEST
				//definition.npcModels[2] = 9638; //CAPE
				definition.npcModels[2] = 64313; //HAND
				//definition.npcModels[4] = 65128; ////shield
				//definition.npcModels[5] = 65142; //WEP
				definition.npcModels[3] = 64311; //LEG
				definition.npcModels[4] = 64314; //BOOT
			...
			case 3777:
				...
				definition.npcModels = new int[6];
				definition.npcModels[0] = 64318; //HEAD
				//definition.npcModels[1] = 64031; //JAW
				definition.npcModels[1] = 64320; //CHEST
				definition.npcModels[2] = 100007; //CAPE
				definition.npcModels[3] = 64324; //HAND
				//definition.npcModels[5] = ; ////shield
				//definition.npcModels[6] = 64488; //WEP
				definition.npcModels[4] = 64322; //LEG
				definition.npcModels[5] = 64325; //BOOT
				definition.originalModelColours = new int[1];
				definition.changedModelColours = new int[1];
				definition.originalModelColours[0] = 40; // current
			...
			case 925:
				definition.name = "<img=15>Elite Slayer Master";
				definition.actions = new String[]{"Talk-to", null, "Get-task", null, "Rewards"};
			...
			case 2843:
				definition.combatLevel = 0;
				definition.name = "@cya@Upgrade Token Shop";
			...
			case 1307:
				...
				definition.scaleY = 300;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.rdc2 = 54666;
				break;
			case 1308:
				definition.name = "Herbal Champion";
				definition.description = "Champion.".getBytes();
				definition.npcModels = new int[]{2545};
				definition.combatLevel = 624;
				definition.standAnimation = 808;
				...
				definition.scaleY = 300;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.rdc2 = 342344;
				break;
			case 1309:
				definition.name = "Water Champion";
				definition.description = "Champion.".getBytes();
				definition.npcModels = new int[]{2545};
				definition.combatLevel = 624;
				definition.standAnimation = 808;
				...
				definition.scaleY = 300;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.rdc2 = 631237;
				break;
			case 1310:
				definition.name = "Lightning Champion";
				definition.description = "Champion.".getBytes();
				definition.npcModels = new int[]{2545};
				definition.combatLevel = 624;
				definition.standAnimation = 808;
				...
				definition.scaleY = 300;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.rdc2 = 76573;
				break;

			case 1311:
				definition.name = "<col=B136DE>Queen Fazula";
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.combatLevel = 1733;
				definition.npcSizeInSquares = 1;
				definition.standAnimation = 808;
				definition.walkAnimation = 819;
				definition.scaleXZ = 170;
				definition.scaleY = 170;
				definition.npcModels = new int[7];
				definition.npcModels[0] = 140831; //HEAD
				//definition.npcModels[1] = -1; //JAW
				definition.npcModels[1] = 140832; //BODY
				//definition.npcModels[2] = 65449; //CAPE
				definition.npcModels[2] = 140835; //GLOVES
				definition.npcModels[3] = 140837; ////shield
				definition.npcModels[4] = 140836; //WEP
				definition.npcModels[5] = 140833; //LEG
				definition.npcModels[6] = 140834; //BOOT
				break;
			case 1312:
				definition.name = "<col=B136DE>Fazula pet";
				...
				break;
			case 1313:
				definition.name = "<col=B136DE>Lord Yasuda";
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.combatLevel = 1733;
				definition.npcSizeInSquares = 1;
				...
				definition.scaleY = 170;
				definition.npcModels = new int[7];
				definition.npcModels[0] = 140838; //HEAD
				//definition.npcModels[1] = -1; //JAW
				definition.npcModels[1] = 140839; //BODY
				definition.npcModels[2] = 140843; //CAPE
				definition.npcModels[3] = 140842; //GLOVES
				//definition.npcModels[3] = 140837; ////shield
				definition.npcModels[4] = 140844; //WEP
				definition.npcModels[5] = 140840; //LEG
				definition.npcModels[6] = 140841; //BOOT
				break;
			case 1314:
				definition.name = "<col=B136DE>Yasuda pet";
				definition.actions = new String[]{null, null, null, null, null};
				definition.combatLevel = 1733;
				definition.npcSizeInSquares = 1;
				definition.standAnimation = 8980;
			...
			case 9014:
				definition.name = "Tarn The Great";
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.combatLevel = 456;
				definition.npcSizeInSquares = 1;
				definition.standAnimation = 808;
				...
				break;
			case 9016:
				definition.name = "Tarn The Great pet";
			 ...
			 */
			case 6692:
				definition.name = "Revenant Wyvern";
				definition.combatLevel = 126;
			...
			case 12886:
				...
				break;
			case 8014:
				definition.name = "Zinqrux";
				definition.description = "Zinqrux.".getBytes();
			...
			case 8012:
				...
				break;
			case 8003:
				definition.name = "Dr. Aberrant";
				definition.description = "Dr. Aberrant.".getBytes();
	...
	*/
			...
			case 2342:
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.name = "Emerald Slayer";
				definition.npcModels = new int[]{64478};
	...
	/*	case 8013:
		...
		definition.npcModels[3] = 65039; //CAPE
			...
			case 93:
				definition.name = "Zorbak";
				MobDefinition zorkak2 = MobDefinition.get(2292);
				definition.description = "GWD.".getBytes();
				definition.npcModels = new int[]{64476};
				definition.combatLevel = zorkak2.combatLevel;
				definition.standAnimation = zorkak2.standAnimation;
				definition.walkAnimation = zorkak2.walkAnimation;
			...
			case 1717:
				...
				definition.name = "Elite Scorpion";
				definition.combatLevel = 40;
				definition.scaleXZ = 350;
				definition.scaleY = 350;
				definition.npcSizeInSquares = 1;
			...
			case 1721:
				...
				break;
			case 1723:
				MobDefinition b171222 = get(7353);
				...
				definition.npcSizeInSquares = 1;
				definition.actions = new String[]{null, "Attack", null, null, null};
				definition.description = b171222.description;
				definition.drawYellowDotOnMap = true;
				definition.npcModels = b171222.npcModels.clone();
				definition.standAnimation = b171222.standAnimation;
				definition.walkAnimation = b171222.walkAnimation;
				definition.degreesToTurn = 32;
				definition.rdc2 = 7454;
				break;
			case 1724:
	...
	public static int _TOTAL_NPCS = 14400;
	...
	public static void load(Archive archive) {
		...
		System.out.println("total npc "+totalNPCs);
		streamIndices = new int[_TOTAL_NPCS];
		int position = 2;
