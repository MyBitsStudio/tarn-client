...
//			itemDef.modifiedModelColors[0] = 60; // the texture that it currently has
			...
			case 18623:
				...
				break;
			case 18629:
				itemDef.name = "@red@Imperial Staff";
...
itemDef.actions[2] = "Dissolve";
			...
			case 5428:
				...
				break;
			case 15043:
				itemDef.name = "Maze Boots";
				break;
			case 6629:
				itemDef.name = "Maze Gloves";
			...
			case 17642:
				itemDef.name = "<col=b5aaaa>Angelic legs";
			...
			case 17632:
				...
				break;
			case 17999:
				itemDef.name = "<col=E3E3E3>Revenant Helmet";
			...
			case 18001:
				itemDef.name = "<col=E3E3E3>Revenant Body";
			...
			case 18003:
				itemDef.name = "<col=E3E3E3>Revenant Legs";
				...
				break;
			case 18005:
				itemDef.name = "<col=E3E3E3>Revenant Wings";
				...
				break;
			case 18007:
				itemDef.name = "<col=E3E3E3>Revenant Shield";
				...
				break;
			case 18009:
				itemDef.name = "<col=E3E3E3>Revenant Boots";
...
itemDef.actions[2] = "Dissolve";
			...
			case 703:
				itemDef.name = "<col=a69eb6>Starter Helm";
				itemDef.modelID = 65354;
				itemDef.maleEquip1 = 65355;
				itemDef.femaleEquip1 = 65355;
				itemdefyogipic = ItemDefinition.get(4882);
			...
			case 704:
				itemDef.name = "<col=a69eb6>Starter Body";
				itemDef.modelID = 65356;
				itemDef.maleEquip1 = 65357;
				itemDef.femaleEquip1 = 65357;
				itemdefyogipic = ItemDefinition.get(4894);
			...
			case 705:
				itemDef.name = "<col=a69eb6>Starter Legs";
				itemDef.modelID = 65358;
				itemDef.maleEquip1 = 65359;
				itemDef.femaleEquip1 = 65359;
				itemdefyogipic = ItemDefinition.get(4900);
			...
			case 8818:
				...
				break;
			case 8811:
				itemDef.name = "<col=7f39f2>Tarn boots";
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 19987:
				itemDef.name = "@cya@Blurite Shield";
				itemdefyogipic = ItemDefinition.get(1540);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
			...
			case 19988:
				itemDef.name = "@cya@Blurite Gloves";
				itemdefyogipic = ItemDefinition.get(7461);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 19989:
				itemDef.name = "@cya@Blurite Boots";
				itemdefyogipic = ItemDefinition.get(7114);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 19991:
				itemDef.name = "@cya@Blurite Amulet";
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 19993:
				itemDef.name = "@cya@Blurite Scimitar";
...
itemDef.actions[2] = "Dissolve";
			...
			//cyan 444444
			case 20086:
				itemDef.name = "@gre@Imperial Helm";
				itemdefyogipic = ItemDefinition.get(4882);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 20087:
				itemDef.name = "@gre@Imperial Body";
				itemdefyogipic = ItemDefinition.get(5575);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 20088:
				itemDef.name = "@gre@Imperial Legs";
				itemdefyogipic = ItemDefinition.get(5576);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 20090:
				itemDef.name = "@gre@Imperial Shield";
				itemdefyogipic = ItemDefinition.get(1540);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
			...
			case 20091:
				itemDef.name = "@gre@Imperial Gloves";
				itemdefyogipic = ItemDefinition.get(7461);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 20089:
				itemDef.name = "@gre@Imperial Boots";
				itemdefyogipic = ItemDefinition.get(7114);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 20092:
				itemDef.name = "@gre@Imperial Amulet";
				itemdefyogipic = ItemDefinition.get(295);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 20093:
				itemDef.name = "@gre@Imperial Ring";
				itemdefyogipic = ItemDefinition.get(1635);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
...
itemDef.actions[2] = "Dissolve";
				...
				break;
			case 21065:
				itemDef.name = "Nagi spirit shield";
				itemdefyogipic = ItemDefinition.get(1540);
				itemDef.modelOffsetX = itemdefyogipic.modelOffsetX;
				itemDef.modelOffsetY = itemdefyogipic.modelOffsetY;
				itemDef.modelZoom = itemdefyogipic.modelZoom;
