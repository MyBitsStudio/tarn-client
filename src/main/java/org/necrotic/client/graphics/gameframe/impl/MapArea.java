...
public class MapArea extends GameFrame {
	...
	enum OrbType {
		...
		HITPOINTS(new int[]{329, -1, 330}, new int[]{1, 2}), PRAYER(new int[]{331, 332, 333}, new int[]{-2, -2}), RUN(new int[]{337, 338, 335, 336}, new int[]{0, -1}), SUMMONING(new int[]{367, 369, 368}, new int[]{0, 0});
	...
	public void displayMoneyPouch(Client client) {
		...
		/*if (client.inSprite(false, Client.spritesMap.get(559), x, fixed ? 82 : 48 + y) || client.inSprite(false, Client.spritesMap.get(566), getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82)) {
			Client.spritesMap.get(559).drawSprite(x, fixed ? 85 : 48 + y);
		} else {
			Client.spritesMap.get(561).drawSprite(x, fixed ? 85 : 48 + y);
		}*/
	...
	public void loadOrbs(Client client, ScreenMode screenMode) {
		try {
			...
			if (client.inSprite(false, Client.spritesMap.get(345), getxPos() - (GameFrame.getScreenMode() == ScreenMode.FIXED ? 2 : 40), getyPos() + (GameFrame.getScreenMode() == ScreenMode.FIXED ? 46 : 2))) {
				...
				Client.spritesMap.get(345).drawSprite(getOffSetX() - (GameFrame.getScreenMode() == ScreenMode.FIXED ? 2 : 40), getOffSetY() + (GameFrame.getScreenMode() == ScreenMode.FIXED ? 46 : 2));
			}
		} catch (NumberFormatException e) {
			e.printStackTrace();
		}
...
//MONEY POUCH
		/*if (client.inSprite(false, Client.spritesMap.get(566), getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82)) {
			...
			client.menuActionName[2] = "Withdraw 1M Coins";
...
//		}
	 ...
	 * ScreenMode.FIXED) return; Client.spritesMap.get(449).drawSprite(getxPos(),
	 * getyPos()); //Client.spritesMap.get(449].blend(); }
	 */
	...
	protected void render(Client client, ScreenMode screenMode) {
		if (isVisible()) {
			...
			client.compass.rotate(33, client.cameraRotation, client.compassArray2, 256, client.compassArray1, 25, getOffSetY() + (screenMode == ScreenMode.FIXED ? 8 : 5), getOffSetX() + (screenMode == ScreenMode.FIXED ? 7 : 5), 33, 25);
			...
			client.compass.rotate(33, client.cameraRotation, client.compassArray2, 256, client.compassArray1, 25, getOffSetY() + (screenMode == ScreenMode.FIXED ? 8 : 4), getOffSetX() + (screenMode == ScreenMode.FIXED ? 7 : 5), 33, 25);
			Client.spritesMap.get(screenMode == ScreenMode.FIXED ? 14 : 13).drawSprite(getOffSetX() - (screenMode == ScreenMode.FIXED ? 1 : 0), getOffSetY() - (screenMode == ScreenMode.FIXED ? 0 : 1));
...
//			}
			...
			if (client.mouseX >= Client.clientWidth - Client.spritesMap.get(342).myWidth && client.mouseX < Client.clientWidth && client.mouseY >= 0 && client.mouseY <= Client.spritesMap.get(342).myHeight) {
				Client.spritesMap.get(342).drawSprite(getOffSetX() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 149 : 225), 0);
			} else {
				Client.spritesMap.get(341).drawSprite(getOffSetX() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 149 : 225), 0);
			}

			if (client.inSprite(false, Client.spritesMap.get(342), getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 149 : 225), 0)) {
				Client.spritesMap.get(342).drawSprite(getOffSetX() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 149 : 225), 0);
			} else {
				Client.spritesMap.get(341).drawSprite(getOffSetX() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 149 : 225), 0);
			}
...
/*
			if (Configuration.MONEY_POUCH_ENABLED) {
				...
				int x = fixed ? 446 : Client.clientWidth - 146;
				int y = fixed ? 0 : 118;
				if (client.inSprite(false, Client.spritesMap.get(559), x, fixed ? 82 : 48 + y) || client.inSprite(false, Client.spritesMap.get(565), getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82)) {
					Client.spritesMap.get(564).drawSprite(getOffSetX() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82);
				} else {
					Client.spritesMap.get(566).drawSprite(getOffSetX() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82);
				}
			} else {
				if (client.inSprite(false, Client.spritesMap.get(566), getxPos() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82)) {
					Client.spritesMap.get(564).drawSprite(getOffSetX() + (GameFrame.getScreenMode() != ScreenMode.FIXED ? 90 : -2), GameFrame.getScreenMode() != ScreenMode.FIXED ? 160 : 82);
