...
public class CustomInterfaces extends RSInterface {
	...
	public static void raidsDifficulty(TextDrawingArea[] tda) {
		RSInterface rsi = addTabInterface(19450);
		rsi.totalChildren(10);

		addSpriteLoader(19451, 2893);
		rsi.child(0, 19451, 170, 42);

		for(int i = 0; i < 3; i++) {
			addHoverButton(19452 + (i * 4), 1610, 99,20, "Upgrade", 0, 19453 + (i * 4), 1);
			rsi.child(1 + (i * 3), 19452 + (i * 4), 220, 106 + (i * 68));
			addHoveredButton(19453 + (i * 4), 1611, 99, 20, 19454 + (i * 4));
			rsi.child(2 + (i * 3), 19453 + (i * 4), 220, 106 + (i * 68));
			addText(19455 + (i * 4), "Difficulty", 0xff9933, true, true, -1, tda, 2);
			rsi.child(3 + (i * 3), 19455 + (i * 4), 265, 108 + (i * 68));
		}
	...
	public static void upgrade(TextDrawingArea[] tda) {
		...
		addSpriteLoader(19401, 2826);
		rsi.child(0, 19401, 11, 14);

		addText(19402, "Upgrade Interface", 0xff9933, true, true, -1, tda, 2);
		rsi.child(1, 19402, 265, 24);

		for(int i = 0; i < 4; i++) {
			addButtonWSpriteLoader(19403 + i, 2827, "View", 118, 32);
			rsi.child(2 + i, 19403 + i, 18 + (i * 118), 50);
			addText(19407 + i, "Category", 0xff981f, false, true, -1, tda, 1);
			rsi.child(6 + i, 19407 + i, 53 + (i * 118), 59);
			addSpriteLoader(19411 + i, 2831 + i);
			rsi.child(10 + i, 19411 + i, 27 + (i * 118) + (i == 2 ? 2 : i == 3 ? -2 : 0), 57 + (i > 1 ? 2 : 0));
		}

		addText(19415, "Select the item you want to upgrade", 0xd7811b, true, true, -1, tda, 1);
		rsi.child(14, 19415, 143, 86);
		addText(19416, "You must have the item in your inventory..", 0x999999, true, true, -1, tda, 1);
		rsi.child(15, 19416, 143, 101);

		addText(19417, "Your Reward if Successful", 0xd7811b, true, true, -1, tda, 1);
		rsi.child(16, 19417, 376, 95);

		addText(19418, "Upgraded Armadyl Godsword", 0xffffff, true, true, -1, tda, 1);
		rsi.child(17, 19418, 376, 130);

		RSInterface item = addInterface(19419);
		...
		rsi.child(18, 19419, 14, 125);

		addToItemGroup(19420, 6, 60, 6, 5, true, false, new String[] {"Upgrade",null,null,null,null}, false);
		item.child(0, 19420, 9, 5);


		addText(19421, "Required Ingredients:", 0xffffff, true, true, -1, tda, 1);
		rsi.child(19, 19421, 376, 205);

		addContainer(19422, 6, 1, 4, 5, false, new String[] { null, null, null, null, null });
		rsi.child(20, 19422, 272, 229);

		for(int i = 0; i < 6; i++) {
			interfaceCache[19422].inv[i] = 4152;
			interfaceCache[19422].invStackSizes[i] = 1;
		}

		addHoverButton(19423, 2829, 125, 35, "Upgrade", 0, 19424, 1);
		rsi.child(21, 19423, 315, 269);
		addHoveredButton(19424, 2828, 125, 35, 19425);
		rsi.child(22, 19424, 315, 269);

		addSpriteLoader(19426, 2830);
		rsi.child(23, 19426, 322, 276);

		addText(19427, "Upgrade", 0xff9933, true, true, -1, tda, 2);
		rsi.child(24, 19427, 385, 279);

		addContainer(19428, 1, 1, 4, 5, false, new String[] { null, null, null, null, null });
		rsi.child(25, 19428, 360, 164);

		interfaceCache[19428].inv[0] = 4152;
		interfaceCache[19428].invStackSizes[0] = 1;

		addCloseButtonSmall(19429, 19430, 19431);
		rsi.child(26, 19429, 472, 23);
		rsi.child(27, 19430, 472, 23);
	}


	public static void teleInterface(TextDrawingArea[] tda) {
		RSInterface rsi = addTabInterface(19000);

		rsi.totalChildren(22);
		addSpriteLoader(19001, 1219);
		rsi.child(0, 19001, 11, 14);

		addText(19002, "Teleportation Interface", 0xff9933, true, true, -1, tda, 2);
		rsi.child(1, 19002, 265, 22);

		for(int i = 0; i < 4; i++) {
			addButtonWSpriteLoader(19003 + i, 1220, "View", 241, 30);
			rsi.child(2 + i, 19003 + i, 39 + (i * 110), 50);
			addText(19007 + i, "Category", 0xff9933, true, true, -1, tda, 0);
			rsi.child(6 + i, 19007 + i, 89 + (i * 110), 55);
		}

		addText(19012, "Long NPC Name", 0xff9933, true, true, -1, tda, 2);
		rsi.child(10, 19012, 252, 82);

		addNpc(19013, 9001);
		rsi.child(11, 19013, 182, 120);

		addText(19014, "Teleport Description", 0xff9933, true, true, -1, tda, 2);
		rsi.child(12, 19014, 407, 82);

		addText(19015, "The teleport brings you to \\n the Custom Boss that drops \\n vast amounts of money!", 0xffffff, true, true, -1, tda, 0);
		rsi.child(13, 19015, 407, 108);

		addHoverButton(19016, 1224, 151, 29, "Teleport", 0, 19017, 1);
		rsi.child(14, 19016, 331, 202);
		addHoveredButton(19017, 1225, 151, 29, 19018);
		rsi.child(15, 19017, 331, 202);
		addText(19019, "Teleport Now", 0xff9933, true, true, -1, tda, 2);
		rsi.child(16, 19019, 407, 209);

		RSInterface teleScroll = addInterface(19020);

		teleScroll.width = 141;
		teleScroll.height = 227;
		teleScroll.scrollMax = 700;
		teleScroll.totalChildren(70);

		rsi.child(17, 19020, 14, 79);

		for(int i = 0; i < 35; i++) {
			addSprite(19021 + i, i % 2 == 0 ? 1222 : 1223);
			teleScroll.child(0 + i, 19021 + i, 11, 0 + (i * 20));
			addClickableText(19056 + i, "Long NPC Name", "Select", tda, 0, 0xFF8900, true, true, 131);
			teleScroll.child(35 + i, 19056 + i, 10, 5 + (i * 20));
		}

		addText(19091, "Possible Drops", 0xff9933, true, true, -1, tda, 2);
		rsi.child(18, 19091, 330, 243);

		RSInterface itemScroll = addInterface(19092);

		itemScroll.width = 290;
		itemScroll.height = 43;
		itemScroll.scrollMax = 130;
		itemScroll.totalChildren(1);

		rsi.child(19, 19092, 176, 263);

		addContainer(19093, 6, 3, 15, 10, false, new String[] { null, null, null, null, null });
		itemScroll.child(0, 19093, 10, 5);

		addCloseButtonSmall(19094, 19095, 19096);
		rsi.child(20, 19094, 472, 23);
		rsi.child(21, 19095, 472, 23);
	}
	...
	public static void grandLottery(TextDrawingArea[] TDA) {
		...
		addText(30906, "Tarn Grand Lottery", TDA, 2, 0xFF981F, true, true);
	...
	public static void playerOwnedShopInterface2(TextDrawingArea[] tda) {
		...
		addToItemGroup(33621, 10, 8, 7, 7, false, false, null, false);
		tab2.totalChildren(1);
	...
	private static void equipmentScreenInterface() {
		...
		setBounds(21178, 36, 30, index++, tab);
		setBounds(21179, 36, 120, index++, tab);
		setBounds(21180, 36, 210, index++, tab);
		setBounds(21181, 179, 28, index++, tab);

		for (int i = 0; i < 5; i++) {
			addText(21190 + i, "", fonts, 1, 0xFF9200, false, true);
			setBounds(21190 + i, 41, 44 + (i * 13), index++, tab);
		}

		for (int i = 0; i < 5; i++) {
			addText(21195 + i, "", fonts, 1, 0xFF9200, false, true);
			setBounds(21195 + i, 41, 135 + (i * 13), index++, tab);
		}

		for (int i = 0; i < 4; i++) {
			addText(21204 + i, "", fonts, 1, 0xFF9200, false, true);
			setBounds(21204 + i, 41, 225 + (i * 13), index++, tab);
		}

		for (int i = 0; i < 4; i++) {
			addText(21200 + i, "", fonts, 0, 0xFF9200, true, true);
			setBounds(21200 + i, 95, 302 + (i * 13), index++, tab);
		}
	...
	public static void staffTabInterface(TextDrawingArea[] tda) {
		...
		addText(id, "Raiding Party", fonts, 2, 16750623, true, true);
	...
	public static void panelInterfaceInterfaces() {
		...
		addText(id, "@whi@Tools", tda, 2, 0xFFFFFF, true, true);
	...
	public static void panelSlayerInterface() {
		int interID = 131000;
		RSInterface tab = addInterface(interID);
		int id = interID + 1;
		int c = 0;
		...
		addText(id, "Slayer Information", tda, 2, 0xFF981F, true, true);
	...
	private void equipmentTab() {
		...
		setBounds(15005, 77, 205, 3, newTab);
	...
	private void playerPanel() {
		...
		addText(39155, "Tarn", tda, 0, ColorConstants.AQUA, false, true);
	...
	private void redoSpellBooks() {
		...
		RSInterface spellButtons;
		RSInterface spellButtons1 = interfaceCache[12424];
		newInterface.totalChildren(9);
		/**
		 * Modern spellbook
		 */
		...
		int x = 10;
		addHoverButtonWSpriteLoader(11001, 2351, 18, 18, "Teleport", -1, 11002, 1);
		...
		addHoverButtonWSpriteLoader(11004, 1942, 18, 18, "Teleport", -1, 11005, 1);
		addTooltip(11005, "Instance Zone\nTeleports you to the \nInstance Zone.");
	...
	public static void upgradeInt(TextDrawingArea[] tda) {
		...
		interfaceId++;
		RSInterface.addSpriteLoader(interfaceId, 1646); // Background.
		RSInterface.setBounds(interfaceId, x, y, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addHoverSpriteLoaderButton(interfaceId, 1647, 15, 15, "Close Window", -1, interfaceId + 1, 1); // Close button.
		RSInterface.setBounds(interfaceId, x + 375, y + 9, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addHoveredImageWSpriteLoader(interfaceId, 1648, 15, 15, interfaceId + 1); // Close button hover.
		RSInterface.setBounds(interfaceId, x + 375, y + 9, children, Interface);
		...
		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "", tda, 0, 0xff9933, true, true);
		RSInterface.setBounds(interfaceId, x + 88, y + 58, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "Required Ingredients", tda, 1, 0xff9933, true, true);
		RSInterface.setBounds(interfaceId, x + 270, y + 41, children, Interface);
		...
		interfaceId++;
		children++;
		RSInterface.addHoveredImageWSpriteLoader(interfaceId, 1653, 83, 20, interfaceId + 1);
		RSInterface.setBounds(interfaceId, x + 273, y + 208, children, Interface);

		interfaceId += 2;
		children++;
		RSInterface.addText(interfaceId, "Concoct", tda, 2, 0xff9933, true, true);
		RSInterface.setBounds(interfaceId, x + 314, y + 210, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "", tda, 1, 0xff9933, true, true);
		RSInterface.setBounds(interfaceId, x + 283 + 34, y + 186, children, Interface);

		interfaceId++;
		children++;
		RSInterface.itemGroup(interfaceId, 1, 1, 5, 3);
		RSInterface.setBounds(interfaceId, x + 210, y + 203, children, Interface);
		...
		interfaceId++;
		children++;
		RSInterface.addHoveredImageWSpriteLoader(interfaceId, 1651, 62, 20, interfaceId + 1);
		RSInterface.setBounds(interfaceId, x + 9, y + 40, children, Interface);
		...
		interfaceId++;
		children++;
		RSInterface.addText(interfaceId, "", tda, 1, 0xff9939, true, true);
		RSInterface.setBounds(interfaceId, x + 283, y + 156, children, Interface);

		interfaceId++;
		children++;
		RSInterface.addSpriteLoader(interfaceId, -1);
		RSInterface.setBounds(interfaceId, x + 283 + 34, y + 144, children, Interface);

		interfaceId++;
		children++;
		RSInterface.itemGroup(interfaceId, 1, 1, 5, 3);
		RSInterface.setBounds(interfaceId, x + 283 + 41, y + 149, children, Interface);

		interfaceId++;
		children++;
		RSInterface nameScroll = RSInterface.addTabInterface(interfaceId);
		RSInterface.setBounds(interfaceId, x + 10, y + 66, children, Interface); // scrollTab2

		interfaceId++;
		children++;
		RSInterface ingScroll = RSInterface.addTabInterface(interfaceId);
		RSInterface.setBounds(interfaceId, x + 208, y + 66, children, Interface); // scrollTab1
		...
		for (int i = 0; i < totalBoxes; i++) {
			RSInterface.addClickableText(interfaceId, "Item name", "View recipe", tda, 0, 0xff9933, false, true, 165);
			nameScroll.child(index++, interfaceId++, x + 2, y + 2);
			y += 14;
		}
		...
		x = 0;
		y = 0;
		RSInterface.itemGroup(interfaceId, 4, 2, 7, 3);
		ingScroll.child(index, interfaceId, x + 4, y + 2);
	}

	public static void itemCombiner(TextDrawingArea[] tda) {
		RSInterface tab = addInterface(43500);
		addSpriteLoader(43501, 1645);
	...
	static void teleportInterface() {
		...
		addText(id, "Elite", tda, 0, ColorConstants.ORANGE, true, true);
